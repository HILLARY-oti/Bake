package com.hillary.baking.fragments;
...
import com.hillary.baking.Adapters.IngredientsAdapter;
import com.hillary.baking.Adapters.StepsAdapter;
import com.hillary.baking.Models.Recipe;
import com.hillary.baking.R;
import com.hillary.baking.RecipeInfoActivity;
import com.hillary.baking.databinding.FragmentRecipeInfoBinding;
...
public class RecipeInfoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        addTab(getString(R.string.title_ingredients), R.id.tab1);
        addTab(getString(R.string.title_steps), R.id.tab2);
